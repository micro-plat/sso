  ...
  export default {
    ...
    methods: {
      ...
      changeSys(v) {
        ...
        this.$http.post("/login/code", {ident: v.ident, code: sessionStorage.getItem("code"), username: user.user_name})
          .then(res => {
