...
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, enable, create_time, sortrank, is_open)VALUES (4, '用户管理', 2, 1, 3, 'fa fa-user-circle text-primary', '/pages/user/index', 1, '2018-6-28 10:06:39', 1, 1);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, enable, create_time, sortrank, is_open)VALUES (5, '角色权限', 2, 1, 3, 'fa fa-users text-danger', '/pages/role/index', 1, '2018-6-28 10:06:52', 2, 1);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, enable, create_time, sortrank, is_open)VALUES (6, '系统管理', 3, 1, 3, 'fa fa-envelope text-success', '/pages/sys/index', 1, '2018-6-28 11:06:03', 1, 1); 
