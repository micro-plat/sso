        ...
        <div class="modal-body">
          ...
          >
              ...
              <el-col :span="12">
                <div class="form-group">
                  ...
                  <div class="form-height text-danger">
                    <span v-show="errors.first('name')">系统名称不能为空</span>
                  </div>
                </div>
              </el-col>
              <el-col :span="12">
            ...
            <div class="form-group">
              ...
              />
              <div class="form-height text-danger">
                <span v-show="errors.first('secret')">secret不能为空</span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input
                ...
                placeholder="logo地址"
                name="logo"
                v-model="addData.logo"
                readonly
              />
              <div class="form-height text-danger">
                <span v-show="errors.first('logo')">logo地址不能为空</span>
              </div>
              <uploader
                :options="options"
