...
INSERT INTO sso_system_info (id, name, index_url, enable, login_timeout, logo, theme, layout, ident, login_url, wechat_status, secret) VALUES (1, '用户系统', 'http://ssov4.100bm.com', 1, 3000, 'http://ssov4.100bm.com/sso/4cd16a1b5b36ac980713ce25c3c7ab0f.png', 'bg-danger|bg-danger|bg-dark dark-danger', 'app-header-fixed', 'sso', '/pages/user/index', 0, 'B128F779D5741E701923346F7FA9F95C');


INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, sortrank, menu_type)VALUES (1, '用户权限', 0, 1, 1, '-', '-', 2, 0);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, sortrank, menu_type)VALUES (2, '用户角色', 1, 1, 2, 'fa fa-users text-info', '-', 2, 0);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, sortrank, menu_type)VALUES (3, '系统功能', 1, 1, 2, 'fa fa-tasks text-info-lter', '-',  3, 0);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, sortrank, menu_type)VALUES (4, '用户管理', 2, 1, 3, 'fa fa-user-circle text-primary', '/pages/user/index', 1, 1);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, sortrank, menu_type)VALUES (5, '角色权限', 2, 1, 3, 'fa fa-users text-danger', '/pages/role/index', 2, 1);
INSERT INTO sso_system_menu(id, name, parent, sys_id, level_id, icon, path, sortrank, menu_type)VALUES (6, '系统管理', 3, 1, 3, 'fa fa-envelope text-success', '/pages/sys/index', 1,  1); 
