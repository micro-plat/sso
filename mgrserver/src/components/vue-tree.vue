<style>
  ...
  .ztree li span.button.add {background: url("../images/ztree/add.png")}
  .ztree li span.button.edit {margin:4px 2px 0 0; background-position:-110px -48px; vertical-align:top; *vertical-align:middle}

  .ztree li span.button.remove {background: url("../images/ztree/delete.png")}
  .ztree li span.button.up { background:url("../images/ztree/up.png")
  }
  .ztree li span.button.down { background:url("../images/ztree/down.png")
  }
  .ztree li span.button.enable { background:url("../images/ztree/enable.png")
  }
  .ztree li span.button.disable { background:url("../images/ztree/disable.png")
  }
