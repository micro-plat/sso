...
type ICacheNotify interface {
	...
	SaveNotifySet(userID, sysID, pi, ps int64, data db.QueryRows, count int) (err error)
	QueryNotifySet(userID, sysID, pi, ps int64) (data db.QueryRows, count int, err error)
