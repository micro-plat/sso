...
func (s *SSO) install() {
	...
	s.Conf.API.SetSubConf("auth", `
		{
			"jwt": {
				"exclude": ["/sso/login","/sso/login/code","/sso/wxcode/get","/sso/sys/get","/qrcode/login","/qrcode/login/put","/sso/user/bind","/wx/login","/sso/notify/send","/qrcode/login/get","/sso/img/upload","/sso/user/getall","/sso/user/info","/sso/user/save","/sso/user/delete","/sso/role/query","/sso/menu/get","/sso/sys/func/query"],
				"source":"header",
				"expireAt": 36000,
				"mode": "HS512",
				"name": "__jwt__",
