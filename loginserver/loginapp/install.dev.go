...
func install() {
	hydra.Conf.API(":6689", api.WithDNS("api.sso.18jiayou1.com")).Header(header.WithCrossDomain()).
		APIKEY("ivk:///check_sign", apikey.WithExcludes("/sso/login/verify", "/image/upload"))
